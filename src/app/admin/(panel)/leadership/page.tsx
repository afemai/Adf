...
const SECTIONS: SectionDef[] = [
  {
    ...
    fields: [
      ...
      { key: "spotlightTitle", label: "Spotlight eyebrow", type: "text", help: "e.g. Conference & AGM (shows in the gold banner on the page)" },
      { key: "spotlightName", label: "Spotlight headline", type: "text" },
      { key: "spotlightRole", label: "Spotlight sub-line", type: "text" },
      { key: "spotlightText", label: "Spotlight description", type: "textarea", rows: 4 },
      { key: "spotlightDate", label: "Spotlight date badge", type: "text", help: "e.g. 25–26 September 2026 · Auchi" },
