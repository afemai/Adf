    ...
    <header className="sticky top-0 z-50">
      ...
      <nav
        ...
        className={cn(
          ...
          scrolled
            ? "bg-cream-50/90 backdrop-blur-md shadow-[0_4px_24px_rgba(6,15,34,0.08)]"
            : "bg-cream-50"
        )}
      >
        <div className="container-site flex items-center justify-between h-18">
          ...
          <div className="hidden lg:flex items-center gap-3">
            <Link
              href="/contact"
              className="inline-flex items-center gap-2 rounded-full bg-gold-500 px-5 py-2.5 text-sm font-bold text-navy-900 shadow-sm transition-all hover:bg-gold-400 hover:shadow-md active:scale-[0.98]"
            >
