...
export default function MaintenanceScreen({ orgName, socials }: { orgName: string; socials?: Socials }) {
  return (
    <main className="flex min-h-screen flex-col items-center justify-center bg-navy-900 px-6 text-center">
      <div className="rounded-full bg-gold-500/15 p-4">
        ...
        <img src="/brand/logo.jpeg" alt="" width={88} height={88} className="rounded-full" />
      </div>
