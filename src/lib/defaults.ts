...
export const DEFAULT_DATA: SiteData = {
  general: {
    ...
    emails: ["afemaidescendantforum@gmail.com"],
  ...
  homepage: {
    ...
    heroImage: "/images/hero-leaders.jpg",
    announcement: {
      enabled: true,
      text: "The Afemai Descendants Forum holds its forthcoming Conference & Annual General Meeting on Friday 25 & Saturday 26 September 2026 in Auchi, Edo State.",
      link: "/leadership",
    ...
    stats: [
      ...
      { value: "7", label: "Incorporated Trustees" },
  ...
  coconut: {
    ...
    videos: [
      ...
      {
        id: "v2",
        src: "/videos/plantation-palms.mp4",
        poster: "/images/poster-plantation-palms.jpg",
        label: "The plantation floor",
        caption: "Walking through a working coconut plantation",
      },
      {
        id: "v3",
        src: "/videos/coconut-harvest.mp4",
        poster: "/images/poster-coconut-harvest.jpg",
        label: "Harvesting the palms",
        caption: "A climber ascending to bring down the ripe nuts",
      },
      {
        id: "v4",
        src: "/videos/plantation-aerial.mp4",
        poster: "/images/poster-plantation-aerial.jpg",
        label: "The farm from above",
        caption: "A vast coconut plantation stretching to the coast",
      },
    ],
  ...
  leadership: {
    ...
    introText:
      "The Afemai Descendants Forum is led by a Board of seven Incorporated Trustees registered with the Corporate Affairs Commission on 23 January 2024. The Forum's structure honours the federal nature of Afemai society — many kingdoms, clans and communities — under one unifying roof.",
    ...
    trusteesIntro: "The seven duly appointed Trustees registered with the Corporate Affairs Commission (Reg. No. 7309739).",
    honorTitle: "Forthcoming Conference & AGM",
    honorText:
      "The Afemai Descendants Forum convenes members and well-wishers for its forthcoming Conference and Annual General Meeting. It is a time to deliberate on unity, heritage preservation, good governance, education, enterprise and the development of Afemai land.",
    spotlightTitle: "Conference & AGM",
    spotlightName: "ADF Forthcoming Conference & Annual General Meeting",
    spotlightRole: "Friday 25 & Saturday 26 September 2026 · Auchi, Edo State",
    spotlightText:
      "The Afemai Descendants Forum convenes members and well-wishers for its forthcoming Conference and Annual General Meeting. It is a time to deliberate on unity, heritage preservation, good governance, education, enterprise and the development of Afemai land.",
    spotlightDate: "25–26 September 2026 · Auchi",
    leaders: [
      {
        id: "l1",
        name: "Cmrd. John Aidenomo Idogho",
        title: "President-General & Chairman, Board of Trustees",
        email: "afemaidescendantforum@gmail.com",
    ...
    gallery: [
      { id: "pres", url: "/images/leader-1.jpg", caption: "Cmrd. John Aidenomo Idogho — President-General of the Afemai Descendants Forum" },
      { id: "nec-w", url: "/images/nec-woman.jpg", caption: "ADF National Executive Committee" },
      { id: "nec-m", url: "/images/nec-man.jpg", caption: "ADF National Executive Committee" },
      { id: "g2", url: "/images/leader-2.jpg", caption: "ADF Leadership portrait" },
      { id: "g3", url: "/images/leader-3.jpg", caption: "ADF Leadership portrait" },
      { id: "g4", url: "/images/leader-4.jpg", caption: "ADF Leadership portrait" },
      { id: "g5", url: "/images/leader-5.jpg", caption: "ADF Leadership portrait" },
      { id: "g6", url: "/images/leader-6.jpg", caption: "ADF Leadership portrait" },
      { id: "g7", url: "/images/leader-7.jpg", caption: "ADF women's wing" },
      { id: "g8", url: "/images/leader-8.jpg", caption: "ADF Leadership portrait" },
    ],
  },
  contact: {
  ...
  events: {
    sectionLabel: "Upcoming Conference & AGM",
    ctaLabel: "Learn More",
    events: [
      {
        id: "e1",
        title: "ADF Conference & Annual General Meeting",
        description:
          "Join the Afemai Descendants Forum for its forthcoming Conference and Annual General Meeting. Deliberations on unity, heritage, development and the way forward for Afemai land. All members and well-wishers are welcome.",
        date: "2026-09-25",
  ...
  press: {
    items: [
      ...
      {
        id: "pv1",
        source: "Official Engagements",
        headline: "ADF courtesy visit to the Egiegba II of Ekperi Kingdom — President-General and Secretary-General",
        url: "",
        date: "September 2026",
        image: "/images/visit-ekperi.jpg",
      },
      {
        id: "pv2",
        source: "Official Engagements",
        headline: "Meeting with the top Royal Fathers in Owan Land",
        url: "",
        date: "September 2026",
        image: "/images/visit-owan.jpg",
      },
      {
        id: "pv3",
        source: "Official Engagements",
        headline: "ADF engagement with community leaders",
        url: "",
        date: "September 2026",
        image: "/images/visit-2.jpg",
      },
      {
        id: "pv4",
        source: "Official Engagements",
        headline: "ADF leadership on official engagements",
        url: "",
        date: "September 2026",
        image: "/images/visit-3.jpg",
      },
    ],
  },
  seo: {
    ...
    perPage: {
      ...
      leadership: { title: "Leadership & Trustees", description: "Meet the Board of Incorporated Trustees and national executives of the Afemai Descendants Forum, and stay informed on the Forum's forthcoming Conference and Annual General Meeting." },
